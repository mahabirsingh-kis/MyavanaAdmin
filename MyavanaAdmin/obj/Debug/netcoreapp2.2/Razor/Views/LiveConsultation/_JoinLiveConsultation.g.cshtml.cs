#pragma checksum "D:\Work2022\My Avana\MyavanaAdminV2\MyavanaAdmin\MyavanaAdmin\Views\LiveConsultation\_JoinLiveConsultation.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f8efb3ffbfe02376e0c8fc38bc96ece52985e8bf"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_LiveConsultation__JoinLiveConsultation), @"mvc.1.0.view", @"/Views/LiveConsultation/_JoinLiveConsultation.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/LiveConsultation/_JoinLiveConsultation.cshtml", typeof(AspNetCore.Views_LiveConsultation__JoinLiveConsultation))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f8efb3ffbfe02376e0c8fc38bc96ece52985e8bf", @"/Views/LiveConsultation/_JoinLiveConsultation.cshtml")]
    ...
    public class Views_LiveConsultation__JoinLiveConsultation : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
...
");
            ...
            EndContext();
            BeginContext(2084, 6023, true);
            WriteLiteral(@"<div class=""modal fade"" id=""CompleteInterviewModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""deleteUserModal"" aria-hidden=""true"" data-keyboard=""false"" data-backdrop=""static"">
...
<div class=""modal fade"" id=""ExitInterviewModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""deleteUserModal"" aria-hidden=""true"" d");
            WriteLiteral(@"ata-keyboard=""false"" data-backdrop=""static"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            <div class=""modal-header"">
...
<div class=""modal fade"" id=""AlreadyJoinedModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""deleteUserModal"" aria-hidden=""true"" data-keyboard=""false"" data-backdrop=""static"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h5 id=""headerTextCo");
            WriteLiteral(@"mplete"" class=""font-bold"">Exit the consultation</h5>
            </div>
            <div class=""modal-body"">
...
<div class=""modal fade"" id=""CandidateLeftFalse"" tabindex=""-1"" role=""dialog"" aria-labelledby=""deleteUserModal"" aria-hidden=""true"" data-keyboard=""false"" data-backdrop=""static"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-danger"" data-dismiss=""modal"" onclick=""completeAndExitInterv");
            WriteLiteral(@"iew()"">Continue</button>
            </div>
        </div>
    </div>
</div>
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f8efb3ffbfe02376e0c8fc38bc96ece52985e8bf11524", async() => {
            }
            );
...
<script type=""text/javascript"">
    ...
    function StopParticipantCount() {
        clearInterval(check");
            WriteLiteral(@"ParticipantCountInterval);
    ...
    function CheckIsCandidateReady() {
        ...
        $.ajax({
            ...
            data: { ""liveConsultationModel"": liveInter");
    ...
    function connectToRoom(token) {
        ...
        Video.connect(token, {
            ...
            /");
            WriteLiteral(@"/ document.getElementById('remote-media-div').innerHTML = """";
            joinedRoom = room;
            ...
            room.on('participantConnected', participant => {
                ...
                $('#btnCompleteInterview').css('display', 'none');
                docume");
            WriteLiteral(@"nt.getElementById('remote-media-div').innerHTML = """";
            ...
            room.on('participantDisconnected', participant => {
                //  alert(""C");
            WriteLiteral(@"andidate disconnected"");
            ...
            room.participants.forEach(participant => {
                ...
                participant.tracks.forEach(publication => {
                    ...
                    publication.on('subscribed', track => {
                        ...
                        publication.track = track;
                        // ");
            WriteLiteral(@"document.getElementById('remote-media-div').appendChild(track.attach());
                    });
                    publication.on('unsubscribed', track => {
            ...
            //checkPar");
            WriteLiteral(@"ticipantCountInterval = setInterval(function () { CheckParticipantCount(); }, 5000);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.isLeft == true) {
                    ...
                    candidateLeft = true;
                 ");
            WriteLiteral(@"   PauseResumeRecording();
                }
                else {
                    var liveInterviewModel = {
                        ""InformationId"": liveConsultationInfoId,
  ...
  ");
            WriteLiteral(@"      Video.createLocalTracks({ audio: { deviceId: videoCameraSelectedDevice }, video: { deviceId: audioSourceSelectedDevice } }).then(function (localTracks) {
    ...
    function finishInterview() {
        ...
        var liveInterviewModel = {
            ...
            ""AdminParticipantI");
            WriteLiteral(@"d"": joinedRoom.localParticipant.sid,
            ""CompleteConsultation"": true,
            ""IsCompleted"": true
        }
        console.log()
    ...
    function PauseResumeRecording() {
        ...
        if (action == ""Pause"") {
            ...
            localParticipant.tracks.forEach(function (publication) {
                ...
                const attachedElements = publication.track.detach();
                attachedElements.forEach(element => element.remove());
                const localMediaContainer = document.getElementById('lo");
            WriteLiteral(@"cal-media-div');
    ...
    function ResumeRe");
        ...
        Video.createLocalTracks({ audio: { deviceId: videoCameraSelectedDevice }, video: { deviceId: audioSourceSelectedDevice } }).then(function (localTracks) {
            ...
            localParticipant.tracks.forEach(function (publication) {
                publi");
            WriteLiteral("cation.isSubscribed = true;\r\n                publication.track.start();\r\n            });\r\n\r\n        });\r\n\r\n    }\r\n</script>\r\n");
            EndContext();
        }
