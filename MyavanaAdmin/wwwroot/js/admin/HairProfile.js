...
function SaveProfile(saveType) {
    ...
    if ($('#txtHairId').val() == '' && $('#txtConsultantNotes').val() == '' && $('#txtHealthSummary').val() == '' && $('#txtStrandDiameter1').val() == '' && $('#txtStrandDiameter2').val() == '' &&
        $('#txtStrandDiameter3').val() == '' && $('#txtStrandDiameter4').val() == '' && $('#txtStrandDiameter5').val() == '' && $('#product').val().length == 0 && $('#productStyling').val().length == 0 && $('#ingredients').val().length == 0 && $('#tools').val().length == 0 && $('#videos').val().length == 0 && $('#regimens').val().length == 0 && $('#stylist').val().length == 0 &&
